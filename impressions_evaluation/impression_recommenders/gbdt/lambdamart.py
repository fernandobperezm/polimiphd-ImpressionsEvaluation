...
class SearchHyperParametersLambdaMARTRecommender(SearchHyperParametersBaseRecommender):
...
class LambdaMARTRecommender(
    ...
    """
    LambdaMART is "lambdarank" + "GBDT"
    """

    RECOMMENDER_NAME = "LambdaMARTRecommender"
    ...
    def __init__(
        ...
        self.model: Optional[lightgbm.LGBMRanker] = None
