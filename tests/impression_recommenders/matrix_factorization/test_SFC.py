...
from impressions_evaluation.impression_recommenders.matrix_factorization.sfc_jax import (
    SoftFrequencyCappingRecommender as RecommenderJax,
    # SFCModel,
    FREQUENCY_MODE,
...
class TestSoftFrequencyCappingRecommenderJAX:
    def test_shape_trained_factors_is_correct(
        self,
        urm: sp.csr_matrix,
        uim: sp.csr_matrix,
